...
**We'd love to list your implementation in the index!**
...
│   ├── specification.md    # Protocol specification (symlink)
...
├── README.md               # Symlink to docs/index.md
├── CONTRIBUTING.md         # Symlink to docs/contributing.md
└── GOVERNANCE.md           # Symlink to docs/governance.md
```
